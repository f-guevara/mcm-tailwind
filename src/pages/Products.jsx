...
function Products() {
    ...
    // Hardcoded descriptions for Cranio Maxillo Facial
    const descriptions = {
        en: "Explore our Cranio Maxillo Facial implants, designed with precision for surgical procedures.",
        de: "Entdecken Sie unsere Cranio Maxillo Facial Implantate, die mit Präzision für chirurgische Eingriffe entwickelt wurden."
    };
    ...
    return (
        <div className="inner-content">
            ...
            <div className="w-full h-64 lg:h-96 overflow-hidden">
                <img
                    src="/implants-2.png"
                    alt="Cranio Maxillo Facial Products"
